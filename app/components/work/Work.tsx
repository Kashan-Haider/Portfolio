...
const Work = () => {
  ...
  const projects: ProjectDataType[] = [
    {
      title: "Master Rag",
      description: "Master RAG is a Streamlit app that lets users upload data, create a RAG chain, and query it with natural language. Pre-trained on medical and car data, it also offers personalized used car recommendations for the Pakistani market..",
      image_path: "/projects/master-rag.png",
      github: "https://github.com/Kashan-Haider/master-rag",
    },
    {
      ...
      live:"https://car-recommendation-model.streamlit.app/"
    },
    {
      title: "Dine Market",
      ...
      live: "https://dine-market-psi.vercel.app/",
    ...
    },
    {
      ...
      live: "https://scribblers-corner.vercel.app",
    ...
    },
    {
      ...
      live: "https://portfolio-website-omega-six-22.vercel.app/",
  ...
  return (
    <div id="work" className="p-5 md:p-10 lg:px-20">
      <h1 className="text-primaryText text-3xl md:text-4xl lg:text-6xl font-bold capitalize mb-5 md:mb-10 lg:mb-20">
        <span className="text-primaryDark"> Featured </span> <br /> works
      </h1>

      <div className="flex items-center justify-center gap-5 flex-wrap">
        {projects.map((item:ProjectDataType, index:number)=>{
          return(
            <ProjectCard key={index} title={item.title} description={item.description} image_path={item.image_path} github={item.github} live={item.live} />
          )
        })}
      </div>
    </div>
